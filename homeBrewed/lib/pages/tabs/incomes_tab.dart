...
class IncomesTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _IncomesList(charID: charID);
  }
}
      ...
      builder: (context, state) {
        return Column(
          children: [
            ...
            SelectableText(
              'Incomes\n',
              style: dndFont.copyWith(fontWeight: FontWeight.bold, fontSize: screenWidth(context) * 0.04),
            ...
            TextButton(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: screenWidth(context) * .02, color: themeColor),
              ),
            ),
            Expanded(
              child: GridView(
